  ...
  return (
    <div class="">
      <div class="relative container mx-auto">
        ...
        <div class="absolute w-full lg:mx-0 font-semibold text-center text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-sans p-10 text-xl lg:text-5xl ">
